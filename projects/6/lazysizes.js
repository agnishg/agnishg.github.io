...
var prefetches = new Set,
  ...
  useMousedownOnly = !1,
  useViewport = !1,
  mouseoverTimer, lastTouchTimestamp, intensity, milliseconds, eventListenersOptions, triggeringFunction;
'instantIntensity' in document.body.dataset && (intensity = document.body.dataset.instantIntensity, intensity.substr(0, 'mousedown'.length) == 'mousedown' ? (useMousedown = !0, intensity == 'mousedown-only' && (useMousedownOnly = !0)) : intensity.substr(0, 'viewport'.length) == 'viewport' ? navigator.connection && (navigator.connection.saveData || navigator.connection.effectiveType && navigator.connection.effectiveType.includes('2g')) || (intensity == "viewport" ? document.documentElement.clientWidth * document.documentElement.clientHeight < 45e4 && (useViewport = !0) : intensity == "viewport-all" && (useViewport = !0)) : (milliseconds = parseInt(intensity), isNaN(milliseconds) || (delayOnHover = milliseconds))), isSupported && (eventListenersOptions = {
  capture: !0,
  passive: !0
}, useMousedownOnly || document.addEventListener('touchstart', touchstartListener, eventListenersOptions), useMousedown ? mousedownShortcut || document.addEventListener('mousedown', mousedownListener, eventListenersOptions) : document.addEventListener('mouseover', mouseoverListener, eventListenersOptions), mousedownShortcut && document.addEventListener('mousedown', mousedownShortcutListener, eventListenersOptions), useViewport && (window.requestIdleCallback ? triggeringFunction = function(a) {
...
function mouseoverListener(b) {
  ...
  a.addEventListener('mouseout', mouseoutListener, {
      ...
      preload(a.href), mouseoverTimer = void 0
  }, delayOnHover)
}
...
function mouseoutListener(a) {
  if (a.relatedTarget && a.target.closest('a') == a.relatedTarget.closest('a')) return;
...
function mousedownShortcutListener(a) {
  var b, c;
  if (performance.now() - lastTouchTimestamp < DELAY_TO_NOT_BE_CONSIDERED_A_TOUCH_INITIATED_ACTION) return;
  if (b = a.target.closest('a'), a.which > 1 || a.metaKey || a.ctrlKey) return;
  if (!b) return;
  b.addEventListener('click', function(a) {
      if (a.detail == 1337) return;
      a.preventDefault()
  }, {
      capture: !0,
      passive: !1,
...
function isPreloadable(a) {
  if (!a || !a.href) return;
  if (useWhitelist && !('instant' in a.dataset)) return;
  if (!allowExternalLinks && a.origin != location.origin && !('instant' in a.dataset)) return;
  if (!['http:', 'https:'].includes(a.protocol)) return;
  if (a.protocol == 'http:' && location.protocol == 'https:') return;
  if (!allowQueryString && a.search && !('instant' in a.dataset)) return;
  if (a.hash && a.pathname + a.search == location.pathname + location.search) return;
  if ('noInstant' in a.dataset) return;
  return !0
}

function preload(a) {
  if (prefetches.has(a)) return;
  var b = document.createElement('link');
  b.rel = 'prefetch', b.href = a, document.head.appendChild(b), prefetches.add(a)
};
/*!
...
function _unsupportedIterableToArray(a, c) {
  if (!a) return;
  if (typeof a == "string") return _arrayLikeToArray(a, c);
  var b = Object.prototype.toString.call(a).slice(8, -1);
  if (b === "Object" && a.constructor && (b = a.constructor.name), b === "Map" || b === "Set") return Array.from(a);
  if (b === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(b)) return _arrayLikeToArray(a, c)
}

function _iterableToArray(a) {
  if (typeof Symbol != "undefined" && Symbol.iterator in Object(a)) return Array.from(a)
}
...
function _objectSpread(c) {
  for (var a = 1, b; a < arguments.length; a++) b = arguments[a] != null ? arguments[a] : {}, a % 2 ? ownKeys(Object(b), !0).forEach(function(a) {
...
$(window).on('scroll', function() {
  $(window).scrollTop() > 50 ? ($('body').addClass('has-fixed-header'), $('#nav-header').addClass('fixed-header ')) : ($('body').removeClass('has-fixed-header'), $('#nav-header').removeClass('fixed-header '))
});
...
$lgInlineContainer = document.getElementById('inline-gallery-container'), $lgInlineContainer && (inlineGallery = window.lightGallery($lgInlineContainer, _objectSpread(_objectSpread({
...

      {
          dynamicEl: [
              ...
              {
                  src: '6/oc1.png',
                  responsive: '6/oc1.png, 6/oc1.png',
                  thumb: '6/oc1.png'
              },
              {
                  src: '6/oc2.png',
                  responsive: '6/oc2.png, 6/oc2.png',
                  thumb: '6/oc2.png'
              },
              {
                  src: '6/oc3.png',
                  responsive: '6/oc3.png, 6/oc3.png',
                  thumb: '6/oc3.png'
              },
              {
                  src: '6/oc5.png',
                  responsive: '6/oc5.png, 6/oc5.png',
                  thumb: '6/oc5.png'
              },
              {
                  src: '6/oc6.png',
                  responsive: '6/oc6.png, 6/oc6.png',
                  thumb: '6/oc6.png'
              },
              {
                  src: '6/oc7.png',
                  responsive: '6/oc7.png, 6/oc7.png',
                  thumb: '6/oc7.png'
              },
              {
                  src: '6/oc8.jpeg',
                  responsive: '6/oc8.jpeg, 6/oc8.jpeg',
                  thumb: '6/oc8.jpeg'
              }
          ]
      })),

  inlineGallery.openGallery()), window.lightGallery(document.getElementById('gallery-demo-animated-thumbnails'), _objectSpread({
  pager: !1,
  hash: !1,
  plugins: [lgZoom, lgAutoplay, lgFullscreen, lgPager, lgRotate, lgShare, lgThumbnail, lgVideo]
}, getResponsiveThumbnailsSettings())), jQuery('#animated-thumbnails-gallery').justifiedGallery({
  captions: !1,
  lastRow: 'hide',
  rowHeight: 180,
  margins: 5
}).on('jg.complete', function() {
  window.lightGallery(document.getElementById('animated-thumbnails-gallery'), _objectSpread(_objectSpread({
      autoplayFirstVideo: !1,
      pager: !1,
      galleryId: 'nature',
      plugins: [lgZoom, lgAutoplay, lgHash, lgFullscreen, lgPager, lgRotate, lgShare, lgThumbnail, lgVideo]
  }, getResponsiveThumbnailsSettings()), {}, {
      preload: 3,
...
}), masonryElMixed = document.getElementById('static-thumbnails-gallery'), masonryElMixed && imagesLoaded(document.getElementById('static-thumbnails-gallery'), function() {
...
}), jQuery('#customize-thumbnails-gallery').justifiedGallery({
  captions: !1,
  lastRow: 'hide',
  rowHeight: 180,
  margins: 5
}).on('jg.complete', function() {
  window.lightGallery(document.getElementById('customize-thumbnails-gallery'), {
      animateThumb: !1,
...
}), $galleryEventsDemo = jQuery('#gallery-events-demo'), galleryEventsDemo = $galleryEventsDemo[0], galleryEventsDemo && (colours = ['#6a7583', '#1e304b', '#315460', '#080607'], galleryEventsDemo.addEventListener('lgBeforeSlide', function(a) {
  var b = a.detail.index;
  document.querySelector('.lg-backdrop').style.backgroundColor = colours[b]
}), $galleryEventsDemo.justifiedGallery({
  captions: !1,
  lastRow: 'justify',
  rowHeight: 180,
  margins: 5
...
function customTransitions(a) {
  jQuery('#gallery-transitions-demo').justifiedGallery({
      captions: !1,
      lastRow: 'justify',
      rowHeight: 180,
      margins: 5
  }).on('jg.complete', function() {
      customTransitionsGallery = window.lightGallery(document.getElementById('gallery-transitions-demo'), {
          mode: a,
          zoom: !1,
          thumbnail: !1,
          rotate: !1,
...
customTransitions('lg-slide'), jQuery('#select-trans').on('change', function() {
  customTransitionsGallery.destroy(), jQuery('#gallery-transitions-demo').justifiedGallery('destroy'), jQuery('#gallery-transitions-demo').off('jg.complete'), customTransitions(jQuery(this).val())
});

function initCustomEasing(a) {
  jQuery('#gallery-custom-easing-demo').justifiedGallery({
      captions: !1,
      lastRow: 'justify',
      rowHeight: 180,
      margins: 5
  }).on('jg.complete', function() {
      customEasingGallery = window.lightGallery(document.getElementById('gallery-custom-easing-demo'), {
          easing: a,
          zoom: !1,
          thumbnail: !1,
          rotate: !1,
...
initCustomEasing('cubic-bezier(0.680, -0.550, 0.265, 1.550)'), jQuery('#select-easing').on('change', function() {
  var a = jQuery(this).val();
  prompt('You can copy cubic-bezier from here', a), customEasingGallery.destroy(), jQuery('#gallery-custom-easing-demo').justifiedGallery('destroy'), jQuery('#gallery-custom-easing-demo').off('jg.complete'), initCustomEasing('cubic-bezier(' + a + ')')
}), $lgGalleryMethodsDemo = document.getElementById('gallery-methods-demo'), $lgGalleryMethodsDemo && ($lgGalleryMethodsDemo.addEventListener('lgInit', function() {
  var b = '<button type="button" aria-label="Previous slide" class="lg-prev"> Prev Slide </button>',
      c = '<button type="button" aria-label="Next slide" class="lg-next"> Next Slide </button>',
      a = document.querySelector('.lg');
  a.insertAdjacentHTML('beforeend', c), a.insertAdjacentHTML('beforeend', b), document.querySelector('.lg-next').addEventListener('click', function() {
      methodsInstance.goToNextSlide()
  }), document.querySelector('.lg-prev').addEventListener('click', function() {
      methodsInstance.goToPrevSlide()
  })
}), jQuery('#gallery-methods-demo').justifiedGallery({
  captions: !1,
  lastRow: 'justify',
  rowHeight: 180,
  margins: 5
...
})), $lgDemoUpdateSlides = jQuery('#gallery-update-slides-demo'), lgDemoUpdateSlides = $lgDemoUpdateSlides.get(0), updateSlidesGallery = null, slidesUpdated = !1, lgDemoUpdateSlides && (lgDemoUpdateSlides.addEventListener('lgAfterClose', function() {
  slidesUpdated && (setTimeout(function() {
      $lgDemoUpdateSlides.justifiedGallery('destroy'), $lgDemoUpdateSlides.off('jg.complete'), $('.lg-added-item').attr('src', 'https://images.unsplash.com/photo-1609342122563-a43ac8917a3a?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=240&q=100')
  }, 100), setTimeout(function() {
      $lgDemoUpdateSlides.justifiedGallery({
          captions: !1,
          lastRow: 'center',
          rowHeight: 180,
          margins: 5
...
})), $dynamicGallery = jQuery('#dynamic-gallery-demo'), dynamicEl = [{
...
}], dynamicGallery = window.lightGallery($dynamicGallery[0], {
  dynamic: !0,
  hash: !1,
  rotate: !1,
  plugins: [lgZoom, lgAutoplay, lgFullscreen, lgPager, lgRotate, lgShare, lgVideo],
  dynamicEl
}), $dynamicGallery.on('click', function() {
  dynamicGallery.openGallery(2)
}), $('#dynamic-gallery-demo-load-more').on('click', function() {
  var a = [{
      ...
      b = [].concat(dynamicEl, a);
  dynamicGallery.refresh(b), dynamicGallery.openGallery(4)
  ...
  selector: 'this'
}), jQuery('#gallery-videos-demo').justifiedGallery({
  captions: !1,
  lastRow: 'justify',
  rowHeight: 180,
  margins: 5
...
}), jQuery('#gallery-videojs-demo').justifiedGallery({
  captions: !1,
  lastRow: 'justify',
  rowHeight: 180,
  margins: 5
...
}), jQuery('#gallery-hash-demo').justifiedGallery({
  captions: !1,
  lastRow: 'justify',
  rowHeight: 180,
  margins: 5
...
}), jQuery('#gallery-custom-hash-demo').justifiedGallery({
  captions: !1,
  lastRow: 'justify',
  rowHeight: 180,
  margins: 5
}).on('jg.complete', function() {
  window.lightGallery(document.getElementById('gallery-custom-hash-demo'), {
      thumbnail: !1,
      plugins: [lgZoom, lgHash, lgAutoplay, lgFullscreen, lgPager, lgRotate, lgShare, lgThumbnail, lgVideo],
      galleryId: 2,
      pager: !1,
      customSlideName: !0
  })
}), jQuery('#gallery-share-demo').justifiedGallery({
  captions: !1,
  lastRow: 'justify',
  rowHeight: 180,
  margins: 5
...
}), jQuery('#gallery-captions-demo').justifiedGallery({
  captions: !1,
  lastRow: 'justify',
  rowHeight: 180,
  margins: 5
...
}), jQuery('#gallery-animated-captions-demo').justifiedGallery({
  captions: !1,
  lastRow: 'justify',
  rowHeight: 180,
  margins: 5
}).on('jg.complete', function() {
  window.lightGallery(document.getElementById('gallery-animated-captions-demo'), {
      speed: 500,
      allowMediaOverlap: !0,
      appendSubHtmlTo: '.lg-item',
      slideDelay: 400
  })
}), jQuery('#gallery-srcset-demo').justifiedGallery({
  captions: !1,
  lastRow: 'justify',
  rowHeight: 180,
  margins: 5
...
}), jQuery('#gallery-picture-demo').justifiedGallery({
  captions: !1,
  lastRow: 'justify',
  rowHeight: 180,
  margins: 5
...
}), jQuery('#responsive-images-demo').justifiedGallery({
  captions: !1,
  lastRow: 'justify',
  rowHeight: 180,
  margins: 5
...
}), jQuery('#gallery-fb-comments-demo').justifiedGallery({
  captions: !1,
  lastRow: 'justify',
  rowHeight: 180,
  margins: 5
}).on('jg.complete', function() {
  window.lightGallery(document.getElementById('gallery-fb-comments-demo'), {
      thumbnail: !1,
      pager: !1,
      hash: !0,
...
}), jQuery('#gallery-disqus-comments-demo').justifiedGallery({
  captions: !1,
  lastRow: 'justify',
  rowHeight: 180,
  margins: 5
}).on('jg.complete', function() {
  window.lightGallery(document.getElementById('gallery-disqus-comments-demo'), {
      thumbnail: !1,
      pager: !1,
      hash: !0,
...
}), jQuery('#gallery-mixed-content-demo').justifiedGallery({
  captions: !1,
  lastRow: 'justify',
  rowHeight: 180,
  margins: 5
}).on('jg.complete', function() {
  window.lightGallery(document.getElementById('gallery-mixed-content-demo'), {
      thumbnail: !1,
      pager: !1,
      hash: !0,
      plugins: [lgZoom, lgAutoplay, lgFullscreen, lgPager, lgRotate, lgShare, lgThumbnail, lgVideo]
  })
}), jQuery('#gallery-mixed-content-all-demo').justifiedGallery({
  captions: !1,
  rowHeight: 130,
  margins: 5
}).on('jg.complete', function() {
  window.lightGallery(document.getElementById('gallery-mixed-content-all-demo'), {
      thumbnail: !1,
      pager: !1,
      hash: !0,
      plugins: [lgZoom, lgAutoplay, lgFullscreen, lgPager, lgRotate, lgShare, lgThumbnail, lgVideo]
  })
}), jQuery('#gallery-share-reddit-demo').justifiedGallery({
  captions: !1,
  lastRow: 'justify',
  rowHeight: 180,
  margins: 5
}).on('jg.complete', function() {
  window.lightGallery(document.getElementById('gallery-share-reddit-demo'), {
      thumbnail: !1,
      pager: !1,
      hash: !0,
      galleryId: 2,
...
}), $infiniteScrollingGallery = $('#infinite-scroll-gallery'), $('#infinite-scroll-gallery').length && (infiniteScrollingGallery = lightGallery($infiniteScrollingGallery[0], {
  ...
  $(window).scrollTop() >= $(document).height() - $(window).height() - ($(document).height() - ($infiniteScrollingGallery.position().top + $infiniteScrollingGallery.outerHeight(!0))) && ($('#infinite-scroll-gallery').append(images), infiniteScrollingGallery.refresh())
